...
namespace JiraManager
{
    ...
    public static class SQLiteHelper
    {
        ...
        public static string LocalDbConnectionString = "Data Source ="+ System.Windows.Forms.Application.StartupPath + "\\" + ConfigSettings.DBName;
        ...
        public static DbDataReader ExecuteReader(SQLiteConnection connection, string commandText, CommandType commandType)
        {
            DbDataReader reader = null;
            SQLiteTransaction trans = null;
            SQLiteCommand cmd = new SQLiteCommand();
            PrepareCommand(cmd, connection, ref trans, false, commandType, commandText);
            return reader = cmd.ExecuteReader(CommandBehavior.CloseConnection);
